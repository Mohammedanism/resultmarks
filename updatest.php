...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE `table 1` SET Name=%s, `Case`=%s WHERE AcdNumber=%s",
  ...
  $Result1 = mysql_query($updateSQL, $config_marks) or die(mysql_error());

  $updateGoTo = "desplayst.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_GET['AcdNumber'])) {
  $colname_Recordset1 = $_GET['AcdNumber'];
}
mysql_select_db($database_config_marks, $config_marks);
$query_Recordset1 = sprintf("SELECT AcdNumber, Name, `Case` FROM `table 1` WHERE AcdNumber = %s ORDER BY AcdNumber ASC", GetSQLValueString($colname_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $config_marks) or die(mysql_error());
...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1 align="center">تعديل بيانات الطلاب</h1>
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
      <table align="center">
        <tr valign="baseline">
          ...
          <td><?php echo $row_Recordset1['AcdNumber']; ?></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><textarea name="Case" cols="50" rows="5"><?php echo htmlentities($row_Recordset1['Case'], ENT_COMPAT, 'utf-8'); ?></textarea></td>
        </tr>
        <tr valign="baseline">
      ...
      <input type="hidden" name="AcdNumber" value="<?php echo $row_Recordset1['AcdNumber']; ?>" />
    </form>
    <p>&nbsp;</p>
<p>&nbsp;</p>
    <!-- end .content --></div>
