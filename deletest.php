...
if ((isset($_GET['AcdNumber'])) && ($_GET['AcdNumber'] != "")) {
  $deleteSQL = sprintf("DELETE FROM ``table 1`` WHERE AcdNumber=%s",
                       GetSQLValueString($_GET['AcdNumber'], "int"));

  mysql_select_db($database_config_marks, $config_marks);
  $Result1 = mysql_query($deleteSQL, $config_marks) or die(mysql_error());

  $deleteGoTo = "desplayst.php";
...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1 align="center">حذف بيانات الطلاب</h1>
