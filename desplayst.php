...
$query_Recordset1 = "SELECT AcdNumber, Name, `Case` FROM `table 1` ORDER BY AcdNumber DESC";
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $config_marks) or die(mysql_error());
...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <p align="center"><a href="https://www.facebook.com/mohammed.ashiba.7" title="Eng Mohammed Ashiba" target="new">Eng Mohammed Ashiba</a></p>
    <!-- end .sidebar1 --></div>
  <div class="content">
    <h1 align="center">عرض بيانات الطلاب</h1>
    ...
    <table border="1">
      ...
      <?php do { ?>
        <tr>
          ...
          <td><?php echo $row_Recordset1['Case']; ?></td>
          <td><a href="updatest.php?AcdNumber=<?php echo $row_Recordset1['AcdNumber']; ?>">تعديل</a><a href="updatest.php"></a></td>
          <td><a href="deletest.php?AcdNumber=<?php echo $row_Recordset1['AcdNumber']; ?>">حذف</a><a href="deletest.php"></a></td>
        </tr>
